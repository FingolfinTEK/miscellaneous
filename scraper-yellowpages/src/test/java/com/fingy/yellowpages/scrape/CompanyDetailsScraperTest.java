...
public class CompanyDetailsScraperTest {
    ...
    private final CompanyDetailsScraper scraper = new CompanyDetailsScraper("", new ScraperLinksQueue());
    ...
    public void testScrapePage() throws Exception {
        ...
        CompanyDetails expected = new CompanyDetails("North American Dismantling & Demolition", "Serving Your Area.", "(800) 664-3697",
                "http://www.nadc1.com", "info@nadc1.com");
