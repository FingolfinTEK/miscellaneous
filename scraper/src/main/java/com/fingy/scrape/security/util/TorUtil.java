...
public class TorUtil {
    ...
    public static void executeTorCommands(final String... commands) {
    ...
    private static void restoreSystemProperties(final Map<?, ?> backup) {
    ...
    public static void disableSocksProxy() {
        System.getProperties().remove(SOCKS_PROXY_HOST_PROPERTY_NAME);
        System.getProperties().remove(SOCKS_PROXY_PORT_PROPERTY_NAME);
    }

    public static void useTorAsProxy() {
        System.getProperties().setProperty(SOCKS_PROXY_HOST_PROPERTY_NAME, TOR_SOKCS_HOST);
        System.getProperties().setProperty(SOCKS_PROXY_PORT_PROPERTY_NAME, TOR_SOKCS_PORT);
    }

    public static String getTorProxyVMArguments() {
        StringBuilder vmArgs = new StringBuilder();
        vmArgs.append("-D").append(SOCKS_PROXY_HOST_PROPERTY_NAME).append("=").append(TOR_SOKCS_HOST);
        vmArgs.append(" ");
        vmArgs.append("-D").append(SOCKS_PROXY_PORT_PROPERTY_NAME).append("=").append(TOR_SOKCS_PORT);
